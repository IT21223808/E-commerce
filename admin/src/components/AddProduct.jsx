...
const AddProduct = () => {
    ...
    return (
        <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7 text-black'>
            <div className='mb-3'>
            ...
            <div className='mb-3 flex item-center gap-x-4'>
                ...
                <select value={productDetails.category} onChange={changeHandler} name='category' id='' className='bg-primary ring-1 ring-slate-900/20 medium-16 riunded-sm outline-none'>
            ...
            <div>
                ...
                <input onChange={imageHandler} type='file' name='image' id='file-input' hidden className='bg-primary max-w-80 w-full py-3 px-4 cursor-pointer' />
            </div>
            <button onClick={() => Add_Product()} className='btn_dark_rounded flexCenter mt-4 gap-x-1 cursor-pointer '><MdAdd />Add Product</button>
        </div>
    )
}
